...
namespace MscItemProp
{
	...
	public class ProcessRegionProp : Property
	{				
		public ProcessRegionProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgRegion");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProcessRegionProp));
			...
			this.groupBox31.Controls.Add(this.optType3);
			this.groupBox31.Controls.Add(this.optType1);
			this.groupBox31.Controls.Add(this.optType2);
			...
			this.hlpProvider.SetHelpKeyword(this.optType3, null);
			...
			this.hlpProvider.SetHelpKeyword(this.optType1, null);
			...
			this.hlpProvider.SetHelpKeyword(this.optType2, null);
		...
		public ProcessStyle Style{
			get{
				if(this.optType1.Checked == true)
					return ProcessStyle.Activation;
				else if(this.optType2.Checked == true)
					return ProcessStyle.Suspension;
				else if(this.optType3.Checked == true)
					return ProcessStyle.Coregion;
				return ProcessStyle.Activation;				
			}
			set{
				if(value==ProcessStyle.Activation)
					this.optType1.Checked = true;
				else if(value==ProcessStyle.Suspension)
					this.optType2.Checked = true;
				else if(value==ProcessStyle.Coregion)
		...
		private void DrawPropertyImage()
		{
			...
			ProcessRegion.RepertoryImage(g,this.Style,this.DiagramStyle);
			g.Dispose();
