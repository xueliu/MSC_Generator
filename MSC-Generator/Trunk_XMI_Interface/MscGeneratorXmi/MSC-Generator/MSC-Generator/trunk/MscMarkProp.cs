...
namespace MscItemProp
{
	...
	public class MscMarkProp : Property
	{
		...
		public MscMarkProp()
		{
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgMark");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MscMarkProp));
			...
			this.txtPropMark = new System.Windows.Forms.TextBox();
			...
			this.tabItemProperty.Controls.Add(this.txtPropMark);
			...
			this.groupBox31.Controls.Add(this.groupBox5);
			this.groupBox31.Controls.Add(this.groupBox4);
			...
			this.groupBox5.AutoSize = ((bool)(resources.GetObject("groupBox5.AutoSize")));
			this.groupBox5.AutoSizeMode = ((System.Windows.Forms.AutoSizeMode)(resources.GetObject("groupBox5.AutoSizeMode")));
			this.groupBox5.BackgroundImage = null;
			this.groupBox5.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("groupBox5.BackgroundImageLayout")));
			this.groupBox5.Controls.Add(this.optDirectionT);
			this.groupBox5.Controls.Add(this.optDirectionB);
			this.groupBox5.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("groupBox5.Dock")));
			this.groupBox5.Font = null;
			this.hlpProvider.SetHelpKeyword(this.groupBox5, null);
			this.hlpProvider.SetHelpNavigator(this.groupBox5, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("groupBox5.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.groupBox5, null);
			...
			this.hlpProvider.SetShowHelp(this.groupBox5, ((bool)(resources.GetObject("groupBox5.ShowHelp"))));
			...
			this.propToolTip.SetToolTip(this.groupBox5, resources.GetString("groupBox5.ToolTip"));
			// 
			// optDirectionT
			// 
			...
			this.optDirectionT.CheckedChanged += new System.EventHandler(this.OptPropertyCheckedChanged);
			// 
			// optDirectionB
			// 
			...
			this.optDirectionB.CheckedChanged += new System.EventHandler(this.OptPropertyCheckedChanged);
			// 
			// groupBox4
			// 
			...
			this.groupBox4.Controls.Add(this.optDirectionL);
			this.groupBox4.Controls.Add(this.optDirectionR);
			...
			// txtPropMark
			// 
			this.txtPropMark.AccessibleDescription = null;
			this.txtPropMark.AccessibleName = null;
			this.txtPropMark.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropMark.Anchor")));
			this.txtPropMark.BackgroundImage = null;
			this.txtPropMark.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropMark.BackgroundImageLayout")));
			this.txtPropMark.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropMark.Dock")));
			this.txtPropMark.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropMark, resources.GetString("txtPropMark.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.txtPropMark, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropMark.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropMark, null);
			this.txtPropMark.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropMark.ImeMode")));
			this.txtPropMark.Location = ((System.Drawing.Point)(resources.GetObject("txtPropMark.Location")));
			this.txtPropMark.MaxLength = ((int)(resources.GetObject("txtPropMark.MaxLength")));
			this.txtPropMark.Multiline = ((bool)(resources.GetObject("txtPropMark.Multiline")));
			this.txtPropMark.Name = "txtPropMark";
			this.txtPropMark.PasswordChar = ((char)(resources.GetObject("txtPropMark.PasswordChar")));
			this.txtPropMark.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropMark.RightToLeft")));
			this.txtPropMark.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropMark.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropMark, ((bool)(resources.GetObject("txtPropMark.ShowHelp"))));
			this.txtPropMark.Size = ((System.Drawing.Size)(resources.GetObject("txtPropMark.Size")));
			this.txtPropMark.TabIndex = ((int)(resources.GetObject("txtPropMark.TabIndex")));
			this.txtPropMark.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropMark.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropMark, resources.GetString("txtPropMark.ToolTip"));
			this.txtPropMark.WordWrap = ((bool)(resources.GetObject("txtPropMark.WordWrap")));
			// 
			// MscMarkProp
			// 
		...
		private System.Windows.Forms.TextBox txtPropMark;
		...
		public string MarkText{
			get{
				return DeformatText(this.txtPropMark.Text);
			}
			set{
				this.txtPropMark.Text = EnformatText(value);
			}
		}
		public MarkPos MarkPosition{
			get{
				if((this.optDirectionL.Checked == true) && (this.optDirectionT.Checked == true))
					return MarkPos.TopLeft;
				else if((this.optDirectionL.Checked == true) && (this.optDirectionB.Checked == true))
					return MarkPos.BottomLeft;
				else if((this.optDirectionR.Checked == true) && (this.optDirectionT.Checked == true))
					return MarkPos.TopRight;
				else if((this.optDirectionR.Checked == true) && (this.optDirectionB.Checked == true))
					return MarkPos.BottomRight;
				else
					return MarkPos.TopLeft;				
			}
			set{
				if(value==MarkPos.TopLeft){
					this.optDirectionL.Checked = true;
					this.optDirectionT.Checked = true;
				}
				else if(value==MarkPos.TopRight){
					this.optDirectionR.Checked = true;
					this.optDirectionT.Checked = true;
				}
				else if(value==MarkPos.BottomLeft){
					this.optDirectionL.Checked = true;
					this.optDirectionB.Checked = true;
				}
				else if(value==MarkPos.BottomRight){
					this.optDirectionR.Checked = true;
					this.optDirectionB.Checked = true;
				}
			}
		...
		private void DrawPropertyImage()
		{
			...
			Mark.RepertoryImage(g,this.MarkPosition);
			g.Dispose();
