...
namespace MscItemProp
{
	...
	public class MeasureStopProp : Property
	{				
		public MeasureStopProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgMeasureStop");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MeasureStopProp));
		...
		public override string PropText{
			get{
				...
				command += ", \"" + this.txtPropGate.Text + "\",";
				command += " \"" + this.txtPropMeasure.Text + "\",";
		...
		public string GateText{
			get{
				return this.txtPropGate.Text;
			}
			set{
				this.txtPropGate.Text = value;
			}
		}	
		public string MeasureText{
			get{
				string text = this.txtPropMeasure.Text;
				text = text.Replace("\r\n","\\n");
				return text;
			}
			set{
		...
		private void DrawPropertyImage()
		{
			...
			MeasureStop.RepertoryImage(g,this.MeasurePosition, this.MeasureStyle);
			g.Dispose();
