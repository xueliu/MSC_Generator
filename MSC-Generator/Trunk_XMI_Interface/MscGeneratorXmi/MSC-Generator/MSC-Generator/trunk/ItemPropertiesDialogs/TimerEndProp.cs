...
namespace MscItemProp
{
	...
	public class TimerEndProp : Property
	{
		
		ItemStyle mItemStyle;
		ItemPos mItemPos;
		
		public TimerEndProp(ItemPos pos, ItemStyle style)
		{
			//
			...
			mItemPos = pos;
			DrawPropertyImage();
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgTimerEnd");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TimerEndProp));
			this.tabItemProperty = new System.Windows.Forms.TabPage();
			this.groupBox21 = new System.Windows.Forms.GroupBox();
			this.groupBox4 = new System.Windows.Forms.GroupBox();
			this.optFormatCancel = new System.Windows.Forms.RadioButton();
			...
			this.tabItemProperty.Controls.Add(this.txtPropTimeout);
			...
			this.groupBox4.Controls.Add(this.optFormatCancel);
			...
			// optFormatCancel
			// 
			this.optFormatCancel.AccessibleDescription = null;
			this.optFormatCancel.AccessibleName = null;
			this.optFormatCancel.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("optFormatCancel.Anchor")));
			this.optFormatCancel.Appearance = ((System.Windows.Forms.Appearance)(resources.GetObject("optFormatCancel.Appearance")));
			this.optFormatCancel.AutoSize = ((bool)(resources.GetObject("optFormatCancel.AutoSize")));
			this.optFormatCancel.BackgroundImage = null;
			this.optFormatCancel.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("optFormatCancel.BackgroundImageLayout")));
			this.optFormatCancel.CheckAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatCancel.CheckAlign")));
			this.optFormatCancel.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("optFormatCancel.Dock")));
			this.optFormatCancel.FlatStyle = ((System.Windows.Forms.FlatStyle)(resources.GetObject("optFormatCancel.FlatStyle")));
			this.optFormatCancel.Font = null;
			this.hlpProvider.SetHelpKeyword(this.optFormatCancel, resources.GetString("optFormatCancel.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.optFormatCancel, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("optFormatCancel.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.optFormatCancel, null);
			this.optFormatCancel.ImageAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatCancel.ImageAlign")));
			this.optFormatCancel.ImageIndex = ((int)(resources.GetObject("optFormatCancel.ImageIndex")));
			this.optFormatCancel.ImageKey = resources.GetString("optFormatCancel.ImageKey");
			this.optFormatCancel.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("optFormatCancel.ImeMode")));
			this.optFormatCancel.Location = ((System.Drawing.Point)(resources.GetObject("optFormatCancel.Location")));
			this.optFormatCancel.Name = "optFormatCancel";
			this.optFormatCancel.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("optFormatCancel.RightToLeft")));
			this.hlpProvider.SetShowHelp(this.optFormatCancel, ((bool)(resources.GetObject("optFormatCancel.ShowHelp"))));
			this.optFormatCancel.Size = ((System.Drawing.Size)(resources.GetObject("optFormatCancel.Size")));
			this.optFormatCancel.TabIndex = ((int)(resources.GetObject("optFormatCancel.TabIndex")));
			this.optFormatCancel.Text = resources.GetString("optFormatCancel.Text");
			this.optFormatCancel.TextAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatCancel.TextAlign")));
			this.optFormatCancel.TextImageRelation = ((System.Windows.Forms.TextImageRelation)(resources.GetObject("optFormatCancel.TextImageRelation")));
			this.propToolTip.SetToolTip(this.optFormatCancel, resources.GetString("optFormatCancel.ToolTip"));
			this.optFormatCancel.UseVisualStyleBackColor = true;
			this.optFormatCancel.CheckedChanged += new System.EventHandler(this.OptPropertyCheckedChanged);
			// 
			// optFormatStandard
			// 
		...
		private System.Windows.Forms.RadioButton optFormatCancel;
		...
		public TimerStyle TimerStyle{
			get{
				if(this.optFormatStandard.Checked == true)
					return TimerStyle.End;
				else if(this.optFormatCancel.Checked == true)
					return TimerStyle.Break;
				return TimerStyle.End;				
			}
			set{
				if(value==TimerStyle.End)
					this.optFormatStandard.Checked = true;
				else if(value==TimerStyle.Break)
					this.optFormatCancel.Checked = true;
			}
		}
		...
		private void OptPropertyCheckedChanged(object sender, System.EventArgs e)
		{
			DrawPropertyImage();
		}
		private void DrawPropertyImage()
		{
			...
			TimerEnd.RepertoryImage(g,this.TimerPosition, this.ItemStyle, this.DiagramStyle, this.TimerStyle);
			g.Dispose();
