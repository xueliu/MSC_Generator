...
namespace MscItemProp
{
	...
	public class StateProp : Property
	{
		public StateProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgState");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(StateProp));
			this.tabItemProperty = new System.Windows.Forms.TabPage();
			this.txtPropState = new System.Windows.Forms.TextBox();
			this.groupBox21 = new System.Windows.Forms.GroupBox();
			this.groupBox41 = new System.Windows.Forms.GroupBox();
			this.optDirectionT = new System.Windows.Forms.RadioButton();
			this.optDirectionB = new System.Windows.Forms.RadioButton();
			this.picPreview = new System.Windows.Forms.PictureBox();
			this.groupBox31 = new System.Windows.Forms.GroupBox();
			this.optStandard = new System.Windows.Forms.RadioButton();
			this.optAlternativ = new System.Windows.Forms.RadioButton();
			...
			this.tabItemProperty.Controls.Add(this.txtPropState);
			...
			// txtPropState
			// 
			this.txtPropState.AccessibleDescription = null;
			this.txtPropState.AccessibleName = null;
			this.txtPropState.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropState.Anchor")));
			this.txtPropState.BackgroundImage = null;
			this.txtPropState.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropState.BackgroundImageLayout")));
			this.txtPropState.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropState.Dock")));
			this.txtPropState.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropState, resources.GetString("txtPropState.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.txtPropState, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropState.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropState, null);
			this.txtPropState.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropState.ImeMode")));
			this.txtPropState.Location = ((System.Drawing.Point)(resources.GetObject("txtPropState.Location")));
			this.txtPropState.MaxLength = ((int)(resources.GetObject("txtPropState.MaxLength")));
			this.txtPropState.Multiline = ((bool)(resources.GetObject("txtPropState.Multiline")));
			this.txtPropState.Name = "txtPropState";
			this.txtPropState.PasswordChar = ((char)(resources.GetObject("txtPropState.PasswordChar")));
			this.txtPropState.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropState.RightToLeft")));
			this.txtPropState.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropState.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropState, ((bool)(resources.GetObject("txtPropState.ShowHelp"))));
			this.txtPropState.Size = ((System.Drawing.Size)(resources.GetObject("txtPropState.Size")));
			this.txtPropState.TabIndex = ((int)(resources.GetObject("txtPropState.TabIndex")));
			this.txtPropState.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropState.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropState, resources.GetString("txtPropState.ToolTip"));
			this.txtPropState.WordWrap = ((bool)(resources.GetObject("txtPropState.WordWrap")));
			// 
			// groupBox21
			// 
			...
			this.groupBox21.Controls.Add(this.groupBox41);
			...
			this.groupBox41.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("groupBox41.Anchor")));
			this.groupBox41.AutoSize = ((bool)(resources.GetObject("groupBox41.AutoSize")));
			this.groupBox41.AutoSizeMode = ((System.Windows.Forms.AutoSizeMode)(resources.GetObject("groupBox41.AutoSizeMode")));
			this.groupBox41.BackgroundImage = null;
			this.groupBox41.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("groupBox41.BackgroundImageLayout")));
			this.groupBox41.Controls.Add(this.optDirectionT);
			this.groupBox41.Controls.Add(this.optDirectionB);
			this.groupBox41.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("groupBox41.Dock")));
			this.groupBox41.Font = null;
			this.hlpProvider.SetHelpKeyword(this.groupBox41, null);
			this.hlpProvider.SetHelpNavigator(this.groupBox41, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("groupBox41.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.groupBox41, null);
			this.groupBox41.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("groupBox41.ImeMode")));
			this.groupBox41.Location = ((System.Drawing.Point)(resources.GetObject("groupBox41.Location")));
			this.groupBox41.Name = "groupBox41";
			this.groupBox41.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("groupBox41.RightToLeft")));
			this.hlpProvider.SetShowHelp(this.groupBox41, ((bool)(resources.GetObject("groupBox41.ShowHelp"))));
			this.groupBox41.Size = ((System.Drawing.Size)(resources.GetObject("groupBox41.Size")));
			this.groupBox41.TabIndex = ((int)(resources.GetObject("groupBox41.TabIndex")));
			this.groupBox41.TabStop = false;
			this.groupBox41.Text = resources.GetString("groupBox41.Text");
			this.propToolTip.SetToolTip(this.groupBox41, resources.GetString("groupBox41.ToolTip"));
			// 
			// optDirectionT
			// 
			this.optDirectionT.AccessibleDescription = null;
			this.optDirectionT.AccessibleName = null;
			this.optDirectionT.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("optDirectionT.Anchor")));
			this.optDirectionT.Appearance = ((System.Windows.Forms.Appearance)(resources.GetObject("optDirectionT.Appearance")));
			this.optDirectionT.AutoSize = ((bool)(resources.GetObject("optDirectionT.AutoSize")));
			this.optDirectionT.BackgroundImage = null;
			this.optDirectionT.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("optDirectionT.BackgroundImageLayout")));
			this.optDirectionT.CheckAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optDirectionT.CheckAlign")));
			this.optDirectionT.Checked = true;
			this.optDirectionT.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("optDirectionT.Dock")));
			this.optDirectionT.FlatStyle = ((System.Windows.Forms.FlatStyle)(resources.GetObject("optDirectionT.FlatStyle")));
			this.optDirectionT.Font = null;
			this.hlpProvider.SetHelpKeyword(this.optDirectionT, resources.GetString("optDirectionT.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.optDirectionT, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("optDirectionT.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.optDirectionT, null);
			this.optDirectionT.ImageAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optDirectionT.ImageAlign")));
			this.optDirectionT.ImageIndex = ((int)(resources.GetObject("optDirectionT.ImageIndex")));
			this.optDirectionT.ImageKey = resources.GetString("optDirectionT.ImageKey");
			this.optDirectionT.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("optDirectionT.ImeMode")));
			this.optDirectionT.Location = ((System.Drawing.Point)(resources.GetObject("optDirectionT.Location")));
			this.optDirectionT.Name = "optDirectionT";
			this.optDirectionT.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("optDirectionT.RightToLeft")));
			this.hlpProvider.SetShowHelp(this.optDirectionT, ((bool)(resources.GetObject("optDirectionT.ShowHelp"))));
			this.optDirectionT.Size = ((System.Drawing.Size)(resources.GetObject("optDirectionT.Size")));
			this.optDirectionT.TabIndex = ((int)(resources.GetObject("optDirectionT.TabIndex")));
			this.optDirectionT.TabStop = true;
			this.optDirectionT.Text = resources.GetString("optDirectionT.Text");
			this.optDirectionT.TextAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optDirectionT.TextAlign")));
			this.optDirectionT.TextImageRelation = ((System.Windows.Forms.TextImageRelation)(resources.GetObject("optDirectionT.TextImageRelation")));
			this.propToolTip.SetToolTip(this.optDirectionT, resources.GetString("optDirectionT.ToolTip"));
			this.optDirectionT.UseVisualStyleBackColor = true;
			// 
			// optDirectionB
			// 
			this.optDirectionB.AccessibleDescription = null;
			this.optDirectionB.AccessibleName = null;
			this.optDirectionB.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("optDirectionB.Anchor")));
			this.optDirectionB.Appearance = ((System.Windows.Forms.Appearance)(resources.GetObject("optDirectionB.Appearance")));
			this.optDirectionB.AutoSize = ((bool)(resources.GetObject("optDirectionB.AutoSize")));
			this.optDirectionB.BackgroundImage = null;
			this.optDirectionB.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("optDirectionB.BackgroundImageLayout")));
			this.optDirectionB.CheckAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optDirectionB.CheckAlign")));
			this.optDirectionB.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("optDirectionB.Dock")));
			this.optDirectionB.FlatStyle = ((System.Windows.Forms.FlatStyle)(resources.GetObject("optDirectionB.FlatStyle")));
			this.optDirectionB.Font = null;
			this.hlpProvider.SetHelpKeyword(this.optDirectionB, resources.GetString("optDirectionB.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.optDirectionB, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("optDirectionB.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.optDirectionB, null);
			this.optDirectionB.ImageAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optDirectionB.ImageAlign")));
			this.optDirectionB.ImageIndex = ((int)(resources.GetObject("optDirectionB.ImageIndex")));
			this.optDirectionB.ImageKey = resources.GetString("optDirectionB.ImageKey");
			this.optDirectionB.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("optDirectionB.ImeMode")));
			this.optDirectionB.Location = ((System.Drawing.Point)(resources.GetObject("optDirectionB.Location")));
			this.optDirectionB.Name = "optDirectionB";
			this.optDirectionB.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("optDirectionB.RightToLeft")));
			this.hlpProvider.SetShowHelp(this.optDirectionB, ((bool)(resources.GetObject("optDirectionB.ShowHelp"))));
			this.optDirectionB.Size = ((System.Drawing.Size)(resources.GetObject("optDirectionB.Size")));
			this.optDirectionB.TabIndex = ((int)(resources.GetObject("optDirectionB.TabIndex")));
			this.optDirectionB.Text = resources.GetString("optDirectionB.Text");
			this.optDirectionB.TextAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optDirectionB.TextAlign")));
			this.optDirectionB.TextImageRelation = ((System.Windows.Forms.TextImageRelation)(resources.GetObject("optDirectionB.TextImageRelation")));
			this.propToolTip.SetToolTip(this.optDirectionB, resources.GetString("optDirectionB.ToolTip"));
			this.optDirectionB.UseVisualStyleBackColor = true;
			// 
			// picPreview
			// 
			...
			this.groupBox31.Controls.Add(this.optStandard);
			this.groupBox31.Controls.Add(this.optAlternativ);
			...
			// optStandard
			// 
			this.optStandard.AccessibleDescription = null;
			this.optStandard.AccessibleName = null;
			this.optStandard.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("optStandard.Anchor")));
			this.optStandard.Appearance = ((System.Windows.Forms.Appearance)(resources.GetObject("optStandard.Appearance")));
			this.optStandard.AutoSize = ((bool)(resources.GetObject("optStandard.AutoSize")));
			this.optStandard.BackgroundImage = null;
			this.optStandard.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("optStandard.BackgroundImageLayout")));
			this.optStandard.CheckAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optStandard.CheckAlign")));
			this.optStandard.Checked = true;
			this.optStandard.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("optStandard.Dock")));
			this.optStandard.FlatStyle = ((System.Windows.Forms.FlatStyle)(resources.GetObject("optStandard.FlatStyle")));
			this.optStandard.Font = null;
			this.hlpProvider.SetHelpKeyword(this.optStandard, resources.GetString("optStandard.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.optStandard, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("optStandard.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.optStandard, null);
			this.optStandard.ImageAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optStandard.ImageAlign")));
			this.optStandard.ImageIndex = ((int)(resources.GetObject("optStandard.ImageIndex")));
			this.optStandard.ImageKey = resources.GetString("optStandard.ImageKey");
			this.optStandard.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("optStandard.ImeMode")));
			this.optStandard.Location = ((System.Drawing.Point)(resources.GetObject("optStandard.Location")));
			this.optStandard.Name = "optStandard";
			this.optStandard.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("optStandard.RightToLeft")));
			this.hlpProvider.SetShowHelp(this.optStandard, ((bool)(resources.GetObject("optStandard.ShowHelp"))));
			this.optStandard.Size = ((System.Drawing.Size)(resources.GetObject("optStandard.Size")));
			this.optStandard.TabIndex = ((int)(resources.GetObject("optStandard.TabIndex")));
			this.optStandard.TabStop = true;
			this.optStandard.Text = resources.GetString("optStandard.Text");
			this.optStandard.TextAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optStandard.TextAlign")));
			this.optStandard.TextImageRelation = ((System.Windows.Forms.TextImageRelation)(resources.GetObject("optStandard.TextImageRelation")));
			this.propToolTip.SetToolTip(this.optStandard, resources.GetString("optStandard.ToolTip"));
			this.optStandard.UseVisualStyleBackColor = true;
			this.optStandard.CheckedChanged += new System.EventHandler(this.PropertiesChanged);
			// 
			// optAlternativ
			// 
			this.optAlternativ.AccessibleDescription = null;
			this.optAlternativ.AccessibleName = null;
			this.optAlternativ.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("optAlternativ.Anchor")));
			this.optAlternativ.Appearance = ((System.Windows.Forms.Appearance)(resources.GetObject("optAlternativ.Appearance")));
			this.optAlternativ.AutoSize = ((bool)(resources.GetObject("optAlternativ.AutoSize")));
			this.optAlternativ.BackgroundImage = null;
			this.optAlternativ.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("optAlternativ.BackgroundImageLayout")));
			this.optAlternativ.CheckAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optAlternativ.CheckAlign")));
			this.optAlternativ.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("optAlternativ.Dock")));
			this.optAlternativ.FlatStyle = ((System.Windows.Forms.FlatStyle)(resources.GetObject("optAlternativ.FlatStyle")));
			this.optAlternativ.Font = null;
			this.hlpProvider.SetHelpKeyword(this.optAlternativ, resources.GetString("optAlternativ.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.optAlternativ, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("optAlternativ.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.optAlternativ, null);
			this.optAlternativ.ImageAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optAlternativ.ImageAlign")));
			this.optAlternativ.ImageIndex = ((int)(resources.GetObject("optAlternativ.ImageIndex")));
			this.optAlternativ.ImageKey = resources.GetString("optAlternativ.ImageKey");
			this.optAlternativ.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("optAlternativ.ImeMode")));
			this.optAlternativ.Location = ((System.Drawing.Point)(resources.GetObject("optAlternativ.Location")));
			this.optAlternativ.Name = "optAlternativ";
			this.optAlternativ.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("optAlternativ.RightToLeft")));
			this.hlpProvider.SetShowHelp(this.optAlternativ, ((bool)(resources.GetObject("optAlternativ.ShowHelp"))));
			this.optAlternativ.Size = ((System.Drawing.Size)(resources.GetObject("optAlternativ.Size")));
			this.optAlternativ.TabIndex = ((int)(resources.GetObject("optAlternativ.TabIndex")));
			this.optAlternativ.Text = resources.GetString("optAlternativ.Text");
			this.optAlternativ.TextAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optAlternativ.TextAlign")));
			this.optAlternativ.TextImageRelation = ((System.Windows.Forms.TextImageRelation)(resources.GetObject("optAlternativ.TextImageRelation")));
			this.propToolTip.SetToolTip(this.optAlternativ, resources.GetString("optAlternativ.ToolTip"));
			this.optAlternativ.UseVisualStyleBackColor = true;
			this.optAlternativ.CheckedChanged += new System.EventHandler(this.PropertiesChanged);
			// 
			// label71
			// 
		...
		private System.Windows.Forms.RadioButton optDirectionB;
		private System.Windows.Forms.RadioButton optDirectionT;
		private System.Windows.Forms.GroupBox groupBox41;
		private System.Windows.Forms.TabPage tabItemProperty;
		private System.Windows.Forms.RadioButton optAlternativ;
		private System.Windows.Forms.RadioButton optStandard;
		private System.Windows.Forms.TextBox txtPropState;
		...
		public string StateText{
			get{
				return DeformatText(this.txtPropState.Text);
			}
			set{
				this.txtPropState.Text = EnformatText(value);
			}
		}
		public override string EditorText{
			...
			set{
				string text = value;
				string command = text.Substring(0,text.IndexOf(':')).Trim();
				if (command.ToLower() == "stateoverall"){
					this.optStandard.Checked = true;
					this.optAlternativ.Enabled = false;
				}
				else{
					this.optAlternativ.Enabled = true;					
				}
		...
		public StateStyle Style{
			get{
				if(this.optStandard.Checked == true)
					return StateStyle.Box;
				else if(this.optAlternativ.Checked == true)
					return StateStyle.Bracket;
				return StateStyle.Box;				
			}
			set{
				if(value==StateStyle.Box)
					this.optStandard.Checked = true;
				else if(value==StateStyle.Bracket)
					this.optAlternativ.Checked = true;
			}
		}
		public ItemPos StatePosition{
			get{
				if(this.optDirectionT.Checked == true)
					return ItemPos.Top;
				if(this.optDirectionB.Checked == true)
					return ItemPos.Bottom;
				return ItemPos.Left;				
			}
			set{
				if(value==ItemPos.Top)
					this.optDirectionT.Checked = true;
				if(value==ItemPos.Bottom)
					this.optDirectionB.Checked = true;
			}
		}
		public override string PropText{
			get{
				string command = mEditorText.Substring(0,mEditorText.IndexOf(':')).Trim();
				if (command.ToLower() == "state"){
					char[] chars = mEditorText.ToCharArray();
					...
					foreach(char c in chars){										// parse the parameters
						...
						else if((c=='"')&&(questionMarks==false)){
							questionMarks = true;
						}
						else if((c=='"')&&(questionMarks==true)){
							questionMarks = false;
						}
					}
					command = mEditorText.Substring(0,pos);
					command += " \"" + this.StateText + "\"";
					if(this.optAlternativ.Checked == true)
						command += ",*";
					else
						command += ",";
				}
				else if (command.ToLower() == "stateoverall"){
					command = mEditorText.Substring(0,mEditorText.IndexOf(':')+1);
					command += " \"" + this.StateText + "\"";					
				}
				if(this.optDirectionT.Checked == true)
					command += ",t";
				else if(this.optDirectionB.Checked == true)
					command += ",b";
		...
		private void DrawPropertyImage()
		{
			...
			State.RepertoryImage(g,this.Style, this.DiagramStyle);
			g.Dispose();
			this.picPreview.Invalidate();		
		}
		
		private void PropertiesChanged(object sender, System.EventArgs e)
		{
			DrawPropertyImage();
			this.picPreview.Invalidate();
		}
