...
namespace xmi{
	...
	public class UmlModel
	{
		...
		public const string MESSAGE_SORT_CREATE_MESSAGE="createMessage";
		...
		public const string FINISH_ATTR_COMPLETE_NAME="xmi:finish";
		public const string START_ATTR_NAME="start";
		public const string START_ATTR_COMPLETE_NAME="xmi:start";
		public const string XMI_ELEMENT_NAME="XMI";
    	...
    	public const string XMI_VERSION_ATTR_COMPLETE_NAME="xmi:version";
		...
		public const string COVERED_ATTR_COMPLETE_NAME="xmi:covered";
		public const string BEHAVIOR_EXECUTION_SPECIFICATION="BehaviorExecutionSpecification";
		public const string UML_BEHAVIOR_EXECUTION_SPECIFICATION="uml:BehaviorExecutionSpecification";
		public const string ACTION_EXECUTION_SPECIFICATION="ActionExecutionSpecification";
		public const string UML_ACTION_EXECUTION_SPECIFICATION="uml:ActionExecutionSpecification";
		...
		public const string EXECUTION_EVENT_COMPLETE_NAME="uml:ExecutionEvent";
		public const string SEND_OPERATION_EVENT="SendOperationEvent";
		public const string SEND_OPERATION_EVENT_COMPLETE_NAME="uml:SendOperationEvent";
		public const string RECEIVE_OPERATION_EVENT="ReceiveOperationEvent";
		public const string RECEIVE_OPERATION_EVENT_COMPLETE_NAME="uml:ReceiveOperationEvent";
		...
		public const string HREF_ATTR_NAME="href";
		public const string SIZE_ATTR_NAME="size";
		public const string REPLY="reply";
		public const string PACKAGE_IMPORT="packageImport";
		public const string IMPORTED_PACKAGE="importedPackage";
	}
}
