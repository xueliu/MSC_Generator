...
{
	if(document.getElementById("ctl00_ContentPlaceHolder1_HomeCenter1_FeaturedArticle1_hideNum") != null)
		max = parseInt(document.getElementById("ctl00_ContentPlaceHolder1_HomeCenter1_FeaturedArticle1_hideNum").value);
...
{
	if(document.getElementById("ctl00_ContentPlaceHolder1_HomeCenter1_FeaturedArticle1_onlyOneRow") != null)
	{
		if(document.getElementById("ctl00_ContentPlaceHolder1_HomeCenter1_FeaturedArticle1_hide"+check) != null)
		{
			document.getElementById("ctl00_ContentPlaceHolder1_HomeCenter1_FeaturedArticle1_onlyOneRow").innerHTML = document.getElementById("ctl00_ContentPlaceHolder1_HomeCenter1_FeaturedArticle1_hide"+check).value;
		}
	}
}
