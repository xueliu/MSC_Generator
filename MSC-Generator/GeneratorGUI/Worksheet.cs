...
//public sWorksheetValues(bool enableFootLine, byte size, byte layout, byte unit, int width, int Height, int LeftMargin, int RightMargin, int TopMargin, int BottomMargin)
		...
		public Worksheet()
		{
			mSizes = new string[7] {strings.GetString("UserDefined"),"A0-ISO","A1-ISO","A2-ISO","A3-ISO","A4-ISO","A5-ISO"};
		...
		{
			footLine.ItemBox = new RectangleF(0, 0, 0, 0);
            ...
            mFootlineItemBox = footLine.ItemBox;
       	}
