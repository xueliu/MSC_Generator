...
namespace MscItemProp
{
	...
	public class LostMessageProp : Property
	{
				
		public LostMessageProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgLostMessage");
			this.hlpProvider.SetHelpNavigator(this.tabOptions, HelpNavigator.KeywordIndex);
			
		}
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LostMessageProp));
		...
		private void DrawPropertyImage()
		{
			...
			if (this.optDirectionL.Checked == true){
				LostMessage.RepertoryImage(g,MessagePos.Left, this.DiagramStyle);
			}
			else{
				LostMessage.RepertoryImage(g,MessagePos.Right, this.DiagramStyle);
			}
			g.Dispose();
