...
namespace xmiImport
{
	...
	public class XmiModelDocumentInterpreter
	{
		...
		public XmiModelDocumentInterpreter(EditorEntryCreator mscEditorConentCreator)
		{
		...
		public ArrayList GetBehaviorExecutionSpecElementsForLifeline(XmlElement lifelineElement)
		{
			...
			ArrayList relevantExecutionOccurrenceSpecElements=GetExecutionOccurrenceSpecElementsForLifeline(interactionElement,lifelineId);
		...
		{
			XmlElement currentMessageOccurrenceSpecElement; 
		...
		public XmlElement GetMessageElementForMessageOccurrenceSpec(XmlElement messageOccurrenceSpecElement)
		{
			...
			relevantMessageElement=interactionElement.SelectSingleNode(query);
			return query;
		}
	}
}
