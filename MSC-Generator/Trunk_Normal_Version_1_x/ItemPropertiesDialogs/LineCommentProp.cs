...
namespace MscItemProp
{
	...
	public class LineCommentProp : Property
	{				
		public LineCommentProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgLineComment");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LineCommentProp));
			this.tabItemProperty = new System.Windows.Forms.TabPage();
			this.groupBox21 = new System.Windows.Forms.GroupBox();
			this.groupBox4 = new System.Windows.Forms.GroupBox();
			this.optFormatAlternativ = new System.Windows.Forms.RadioButton();
			...
			this.groupBox4.Controls.Add(this.optFormatAlternativ);
			...
			// optFormatAlternativ
			// 
			this.optFormatAlternativ.AccessibleDescription = null;
			this.optFormatAlternativ.AccessibleName = null;
			this.optFormatAlternativ.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("optFormatAlternativ.Anchor")));
			this.optFormatAlternativ.Appearance = ((System.Windows.Forms.Appearance)(resources.GetObject("optFormatAlternativ.Appearance")));
			this.optFormatAlternativ.AutoSize = ((bool)(resources.GetObject("optFormatAlternativ.AutoSize")));
			this.optFormatAlternativ.BackgroundImage = null;
			this.optFormatAlternativ.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("optFormatAlternativ.BackgroundImageLayout")));
			this.optFormatAlternativ.CheckAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatAlternativ.CheckAlign")));
			this.optFormatAlternativ.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("optFormatAlternativ.Dock")));
			this.optFormatAlternativ.FlatStyle = ((System.Windows.Forms.FlatStyle)(resources.GetObject("optFormatAlternativ.FlatStyle")));
			this.optFormatAlternativ.Font = null;
			this.hlpProvider.SetHelpKeyword(this.optFormatAlternativ, resources.GetString("optFormatAlternativ.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.optFormatAlternativ, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("optFormatAlternativ.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.optFormatAlternativ, null);
			this.optFormatAlternativ.ImageAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatAlternativ.ImageAlign")));
			this.optFormatAlternativ.ImageIndex = ((int)(resources.GetObject("optFormatAlternativ.ImageIndex")));
			this.optFormatAlternativ.ImageKey = resources.GetString("optFormatAlternativ.ImageKey");
			this.optFormatAlternativ.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("optFormatAlternativ.ImeMode")));
			this.optFormatAlternativ.Location = ((System.Drawing.Point)(resources.GetObject("optFormatAlternativ.Location")));
			this.optFormatAlternativ.Name = "optFormatAlternativ";
			this.optFormatAlternativ.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("optFormatAlternativ.RightToLeft")));
			this.hlpProvider.SetShowHelp(this.optFormatAlternativ, ((bool)(resources.GetObject("optFormatAlternativ.ShowHelp"))));
			this.optFormatAlternativ.Size = ((System.Drawing.Size)(resources.GetObject("optFormatAlternativ.Size")));
			this.optFormatAlternativ.TabIndex = ((int)(resources.GetObject("optFormatAlternativ.TabIndex")));
			this.optFormatAlternativ.Text = resources.GetString("optFormatAlternativ.Text");
			this.optFormatAlternativ.TextAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatAlternativ.TextAlign")));
			this.optFormatAlternativ.TextImageRelation = ((System.Windows.Forms.TextImageRelation)(resources.GetObject("optFormatAlternativ.TextImageRelation")));
			this.propToolTip.SetToolTip(this.optFormatAlternativ, resources.GetString("optFormatAlternativ.ToolTip"));
			this.optFormatAlternativ.UseVisualStyleBackColor = true;
			this.optFormatAlternativ.CheckedChanged += new System.EventHandler(this.PropertiesChanged);
			// 
			// optFormatStandard
			// 
			...
			this.optFormatStandard.CheckedChanged += new System.EventHandler(this.PropertiesChanged);
			// 
			// picPreview
			// 
			...
			this.optDirectionL.CheckedChanged += new System.EventHandler(this.PropertiesChanged);
			// 
			// optDirectionR
			// 
			...
			this.optDirectionR.CheckedChanged += new System.EventHandler(this.PropertiesChanged);
			// 
			// label71
			// 
			...
			this.hlpProvider.SetHelpString(this.txtPropComment, null);
		...
		private System.Windows.Forms.RadioButton optFormatAlternativ;
		...
		public bool CommentLine{
			get{
				if(this.optFormatStandard.Checked == true)
					return true;
				if(this.optFormatAlternativ.Checked == true)
					return false;
				return true;
			}
			set{
				if (value == true)
					...
					this.optFormatAlternativ.Checked = true;
			}
		}
		...
		private void DrawPropertyImage()
		{
			...
			LineComment.RepertoryImage(g,pos,drawLine);
			g.Dispose();
			this.picPreview.Invalidate();		
		}
		
		void PropertiesChanged(object sender, System.EventArgs e)
		{
			DrawPropertyImage();
			this.picPreview.Invalidate();
		}
