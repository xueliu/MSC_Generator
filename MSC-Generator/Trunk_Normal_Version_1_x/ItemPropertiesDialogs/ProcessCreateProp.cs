...
namespace MscItemProp
{
	...
	public class ProcessCreateProp : Property
	{
		public ProcessCreateProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgCreate");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProcessCreateProp));
			...
			this.hlpProvider.SetHelpKeyword(this.txtPropDescription, null);
			...
			this.hlpProvider.SetHelpKeyword(this.txtPropProcess, null);
			...
			this.hlpProvider.SetHelpKeyword(this.txtPropMessage, null);
		...
		public override string PropText{
			get{
				int pos = mEditorText.IndexOf(',')+1; // source Instance
				pos = mEditorText.IndexOf(',', pos)+1; // destination Instance
				string command = mEditorText.Substring(0,pos);
				command += "\"" + this.MessageText + "\"," + "\"" + this.ProcessText + "\"," + "\"" + this.DescriptionText + "\"";
