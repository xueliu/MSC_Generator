...
namespace MscItemProp
{
	...
	public class ReferenceProp : Property
	{
		...
		public ReferenceProp()
		{
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgReference");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ReferenceProp));
			this.tabItemProperty = new System.Windows.Forms.TabPage();
			this.label71 = new System.Windows.Forms.Label();
			this.txtPropReference = new System.Windows.Forms.TextBox();
			...
			this.tabItemProperty.Controls.Add(this.txtPropReference);
			...
			// txtPropReference
			// 
			this.txtPropReference.AccessibleDescription = null;
			this.txtPropReference.AccessibleName = null;
			this.txtPropReference.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropReference.Anchor")));
			this.txtPropReference.BackgroundImage = null;
			this.txtPropReference.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropReference.BackgroundImageLayout")));
			this.txtPropReference.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropReference.Dock")));
			this.txtPropReference.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropReference, resources.GetString("txtPropReference.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.txtPropReference, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropReference.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropReference, null);
			this.txtPropReference.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropReference.ImeMode")));
			this.txtPropReference.Location = ((System.Drawing.Point)(resources.GetObject("txtPropReference.Location")));
			this.txtPropReference.MaxLength = ((int)(resources.GetObject("txtPropReference.MaxLength")));
			this.txtPropReference.Multiline = ((bool)(resources.GetObject("txtPropReference.Multiline")));
			this.txtPropReference.Name = "txtPropReference";
			this.txtPropReference.PasswordChar = ((char)(resources.GetObject("txtPropReference.PasswordChar")));
			this.txtPropReference.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropReference.RightToLeft")));
			this.txtPropReference.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropReference.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropReference, ((bool)(resources.GetObject("txtPropReference.ShowHelp"))));
			this.txtPropReference.Size = ((System.Drawing.Size)(resources.GetObject("txtPropReference.Size")));
			this.txtPropReference.TabIndex = ((int)(resources.GetObject("txtPropReference.TabIndex")));
			this.txtPropReference.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropReference.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropReference, resources.GetString("txtPropReference.ToolTip"));
			this.txtPropReference.WordWrap = ((bool)(resources.GetObject("txtPropReference.WordWrap")));
			// 
			// ReferenceProp
			// 
		...
		private System.Windows.Forms.TextBox txtPropReference;
		#endregion
		...
		public string ReferenceText{
			get{
				return DeformatText(this.txtPropReference.Text);
			}
			set{
				this.txtPropReference.Text = EnformatText(value);
			}
		}	
