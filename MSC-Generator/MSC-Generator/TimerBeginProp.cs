...
namespace MscItemProp
{
	...
	public class TimerBeginProp : Property
	{
		public TimerBeginProp()
		{
			//
			...
			InitializeComponent();
			SetSize();
//			this.UseStyle(this.DiagramStyle);
			DrawPropertyImage();
			this.tabOptions.SelectedIndex = 2;
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgTimerBegin");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TimerBeginProp));
			this.tabItem = new System.Windows.Forms.TabPage();
			this.groupBox21 = new System.Windows.Forms.GroupBox();
			this.fraTextDirection = new System.Windows.Forms.GroupBox();
			...
			this.optFormatExtended = new System.Windows.Forms.RadioButton();
			this.optFormatStandard = new System.Windows.Forms.RadioButton();
			...
			this.txtPropTimeout = new System.Windows.Forms.TextBox();
			this.label71 = new System.Windows.Forms.Label();
			this.tabPageWorksheet.SuspendLayout();
			this.tabOptions.SuspendLayout();
			this.tabItem.SuspendLayout();
			this.groupBox21.SuspendLayout();
			this.fraTextDirection.SuspendLayout();
			...
			this.tabItem.Controls.Add(this.txtPropTimeout);
			...
			this.groupBox21.Controls.Add(this.fraTextDirection);
			...
			// fraTextDirection
			// 
			this.fraTextDirection.AccessibleDescription = null;
			this.fraTextDirection.AccessibleName = null;
			this.fraTextDirection.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("fraTextDirection.Anchor")));
			this.fraTextDirection.AutoSize = ((bool)(resources.GetObject("fraTextDirection.AutoSize")));
			this.fraTextDirection.AutoSizeMode = ((System.Windows.Forms.AutoSizeMode)(resources.GetObject("fraTextDirection.AutoSizeMode")));
			this.fraTextDirection.BackgroundImage = null;
			this.fraTextDirection.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("fraTextDirection.BackgroundImageLayout")));
			this.fraTextDirection.Controls.Add(this.optFormatOuter);
			this.fraTextDirection.Controls.Add(this.optFormatInner);
			this.fraTextDirection.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("fraTextDirection.Dock")));
			this.fraTextDirection.Font = null;
			this.hlpProvider.SetHelpKeyword(this.fraTextDirection, null);
			this.hlpProvider.SetHelpNavigator(this.fraTextDirection, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("fraTextDirection.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.fraTextDirection, null);
			this.fraTextDirection.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("fraTextDirection.ImeMode")));
			this.fraTextDirection.Location = ((System.Drawing.Point)(resources.GetObject("fraTextDirection.Location")));
			this.fraTextDirection.Name = "fraTextDirection";
			this.fraTextDirection.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("fraTextDirection.RightToLeft")));
			this.hlpProvider.SetShowHelp(this.fraTextDirection, ((bool)(resources.GetObject("fraTextDirection.ShowHelp"))));
			this.fraTextDirection.Size = ((System.Drawing.Size)(resources.GetObject("fraTextDirection.Size")));
			this.fraTextDirection.TabIndex = ((int)(resources.GetObject("fraTextDirection.TabIndex")));
			this.fraTextDirection.TabStop = false;
			this.fraTextDirection.Text = resources.GetString("fraTextDirection.Text");
			this.propToolTip.SetToolTip(this.fraTextDirection, resources.GetString("fraTextDirection.ToolTip"));
			// 
			// optFormatOuter
			// 
			...
			this.hlpProvider.SetHelpKeyword(this.optFormatOuter, null);
			...
			this.optFormatOuter.CheckedChanged += new System.EventHandler(this.OptPropertyCheckedChanged);
			// 
			// optFormatInner
			// 
			...
			this.hlpProvider.SetHelpKeyword(this.optFormatInner, null);
			...
			this.optFormatInner.CheckedChanged += new System.EventHandler(this.OptPropertyCheckedChanged);
			// 
			// groupBox4
			// 
			...
			this.groupBox4.Controls.Add(this.optFormatExtended);
			this.groupBox4.Controls.Add(this.optFormatStandard);
			...
			// optFormatExtended
			// 
			this.optFormatExtended.AccessibleDescription = null;
			this.optFormatExtended.AccessibleName = null;
			this.optFormatExtended.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("optFormatExtended.Anchor")));
			this.optFormatExtended.Appearance = ((System.Windows.Forms.Appearance)(resources.GetObject("optFormatExtended.Appearance")));
			this.optFormatExtended.AutoSize = ((bool)(resources.GetObject("optFormatExtended.AutoSize")));
			this.optFormatExtended.BackgroundImage = null;
			this.optFormatExtended.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("optFormatExtended.BackgroundImageLayout")));
			this.optFormatExtended.CheckAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatExtended.CheckAlign")));
			this.optFormatExtended.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("optFormatExtended.Dock")));
			this.optFormatExtended.FlatStyle = ((System.Windows.Forms.FlatStyle)(resources.GetObject("optFormatExtended.FlatStyle")));
			this.optFormatExtended.Font = null;
			this.hlpProvider.SetHelpKeyword(this.optFormatExtended, null);
			this.hlpProvider.SetHelpNavigator(this.optFormatExtended, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("optFormatExtended.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.optFormatExtended, null);
			this.optFormatExtended.ImageAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatExtended.ImageAlign")));
			this.optFormatExtended.ImageIndex = ((int)(resources.GetObject("optFormatExtended.ImageIndex")));
			this.optFormatExtended.ImageKey = resources.GetString("optFormatExtended.ImageKey");
			this.optFormatExtended.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("optFormatExtended.ImeMode")));
			this.optFormatExtended.Location = ((System.Drawing.Point)(resources.GetObject("optFormatExtended.Location")));
			this.optFormatExtended.Name = "optFormatExtended";
			this.optFormatExtended.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("optFormatExtended.RightToLeft")));
			this.hlpProvider.SetShowHelp(this.optFormatExtended, ((bool)(resources.GetObject("optFormatExtended.ShowHelp"))));
			this.optFormatExtended.Size = ((System.Drawing.Size)(resources.GetObject("optFormatExtended.Size")));
			this.optFormatExtended.TabIndex = ((int)(resources.GetObject("optFormatExtended.TabIndex")));
			this.optFormatExtended.Text = resources.GetString("optFormatExtended.Text");
			this.optFormatExtended.TextAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatExtended.TextAlign")));
			this.optFormatExtended.TextImageRelation = ((System.Windows.Forms.TextImageRelation)(resources.GetObject("optFormatExtended.TextImageRelation")));
			this.propToolTip.SetToolTip(this.optFormatExtended, resources.GetString("optFormatExtended.ToolTip"));
			this.optFormatExtended.UseVisualStyleBackColor = true;
			this.optFormatExtended.CheckedChanged += new System.EventHandler(this.OptPropertyCheckedChanged);
			// 
			// optFormatStandard
			// 
			this.optFormatStandard.AccessibleDescription = null;
			this.optFormatStandard.AccessibleName = null;
			this.optFormatStandard.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("optFormatStandard.Anchor")));
			this.optFormatStandard.Appearance = ((System.Windows.Forms.Appearance)(resources.GetObject("optFormatStandard.Appearance")));
			this.optFormatStandard.AutoSize = ((bool)(resources.GetObject("optFormatStandard.AutoSize")));
			this.optFormatStandard.BackgroundImage = null;
			this.optFormatStandard.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("optFormatStandard.BackgroundImageLayout")));
			this.optFormatStandard.CheckAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatStandard.CheckAlign")));
			this.optFormatStandard.Checked = true;
			this.optFormatStandard.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("optFormatStandard.Dock")));
			this.optFormatStandard.FlatStyle = ((System.Windows.Forms.FlatStyle)(resources.GetObject("optFormatStandard.FlatStyle")));
			this.optFormatStandard.Font = null;
			this.hlpProvider.SetHelpKeyword(this.optFormatStandard, null);
			this.hlpProvider.SetHelpNavigator(this.optFormatStandard, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("optFormatStandard.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.optFormatStandard, null);
			this.optFormatStandard.ImageAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatStandard.ImageAlign")));
			this.optFormatStandard.ImageIndex = ((int)(resources.GetObject("optFormatStandard.ImageIndex")));
			this.optFormatStandard.ImageKey = resources.GetString("optFormatStandard.ImageKey");
			this.optFormatStandard.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("optFormatStandard.ImeMode")));
			this.optFormatStandard.Location = ((System.Drawing.Point)(resources.GetObject("optFormatStandard.Location")));
			this.optFormatStandard.Name = "optFormatStandard";
			this.optFormatStandard.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("optFormatStandard.RightToLeft")));
			this.hlpProvider.SetShowHelp(this.optFormatStandard, ((bool)(resources.GetObject("optFormatStandard.ShowHelp"))));
			this.optFormatStandard.Size = ((System.Drawing.Size)(resources.GetObject("optFormatStandard.Size")));
			this.optFormatStandard.TabIndex = ((int)(resources.GetObject("optFormatStandard.TabIndex")));
			this.optFormatStandard.TabStop = true;
			this.optFormatStandard.Text = resources.GetString("optFormatStandard.Text");
			this.optFormatStandard.TextAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("optFormatStandard.TextAlign")));
			this.optFormatStandard.TextImageRelation = ((System.Windows.Forms.TextImageRelation)(resources.GetObject("optFormatStandard.TextImageRelation")));
			this.propToolTip.SetToolTip(this.optFormatStandard, resources.GetString("optFormatStandard.ToolTip"));
			this.optFormatStandard.UseVisualStyleBackColor = true;
			this.optFormatStandard.CheckedChanged += new System.EventHandler(this.OptPropertyCheckedChanged);
			// 
			// picPreview
			// 
			...
			this.hlpProvider.SetHelpKeyword(this.optDirectionL, null);
			...
			this.optDirectionL.CheckedChanged += new System.EventHandler(this.OptPropertyCheckedChanged);
			// 
			// optDirectionR
			// 
			...
			this.hlpProvider.SetHelpKeyword(this.optDirectionR, null);
			...
			this.optDirectionR.CheckedChanged += new System.EventHandler(this.OptPropertyCheckedChanged);
			// 
			// txtPropTimeout
			// 
			this.txtPropTimeout.AccessibleDescription = null;
			this.txtPropTimeout.AccessibleName = null;
			this.txtPropTimeout.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropTimeout.Anchor")));
			this.txtPropTimeout.BackgroundImage = null;
			this.txtPropTimeout.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropTimeout.BackgroundImageLayout")));
			this.txtPropTimeout.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropTimeout.Dock")));
			this.txtPropTimeout.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropTimeout, null);
			this.hlpProvider.SetHelpNavigator(this.txtPropTimeout, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropTimeout.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropTimeout, null);
			this.txtPropTimeout.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropTimeout.ImeMode")));
			this.txtPropTimeout.Location = ((System.Drawing.Point)(resources.GetObject("txtPropTimeout.Location")));
			this.txtPropTimeout.MaxLength = ((int)(resources.GetObject("txtPropTimeout.MaxLength")));
			this.txtPropTimeout.Multiline = ((bool)(resources.GetObject("txtPropTimeout.Multiline")));
			this.txtPropTimeout.Name = "txtPropTimeout";
			this.txtPropTimeout.PasswordChar = ((char)(resources.GetObject("txtPropTimeout.PasswordChar")));
			this.txtPropTimeout.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropTimeout.RightToLeft")));
			this.txtPropTimeout.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropTimeout.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropTimeout, ((bool)(resources.GetObject("txtPropTimeout.ShowHelp"))));
			this.txtPropTimeout.Size = ((System.Drawing.Size)(resources.GetObject("txtPropTimeout.Size")));
			this.txtPropTimeout.TabIndex = ((int)(resources.GetObject("txtPropTimeout.TabIndex")));
			this.txtPropTimeout.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropTimeout.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropTimeout, resources.GetString("txtPropTimeout.ToolTip"));
			this.txtPropTimeout.WordWrap = ((bool)(resources.GetObject("txtPropTimeout.WordWrap")));
			// 
			// label71
			// 
			...
			this.fraTextDirection.ResumeLayout(false);
			this.groupBox4.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.picPreview)).EndInit();
			this.groupBox31.ResumeLayout(false);
			this.ResumeLayout(false);
		}
		private System.Windows.Forms.GroupBox fraTextDirection;
		private System.Windows.Forms.RadioButton optFormatExtended;
		private System.Windows.Forms.RadioButton optFormatStandard;
		private System.Windows.Forms.TextBox txtPropTimeout;
		...
		public override string PropText{
			get{
				int pos = mEditorText.IndexOf(',')+1; // Message iD
				pos = mEditorText.IndexOf(',', pos)+1; // Instance
				string command = mEditorText.Substring(0,pos);
				command += "\"" + this.TimerText + "\",";
				if(this.optDirectionL.Checked == true)
					command += "l";				
				else if(this.optDirectionR.Checked == true)
					command += "r";
				if(this.optFormatExtended.Checked == true){
		...
		public string TimerText{
			get{
				return DeformatText(this.txtPropTimeout.Text);
			}
			set{
				this.txtPropTimeout.Text = EnformatText(value);
			}
		}	
		public ItemPos TimerPosition{
			get{
				if(this.optDirectionL.Checked == true)
					return ItemPos.Left;
				else if(this.optDirectionR.Checked == true)
					return ItemPos.Right;
				return ItemPos.Left;				
			}
			set{
				if(value==ItemPos.Left)
					this.optDirectionL.Checked = true;
				else if(value==ItemPos.Right)
					this.optDirectionR.Checked = true;
			}
		}
		public ItemStyle TimerStyle{
			get{
				if(this.optFormatStandard.Checked == true)
					return ItemStyle.Normal;
				else if(this.optFormatExtended.Checked == true){
					if (this.optFormatInner.Checked == true)
						return ItemStyle.ExtendedInner;
					else if (this.optFormatOuter.Checked == true)
						return ItemStyle.ExtendedOuter;
				}
				return ItemStyle.Normal;				
			}
			set{
				if(value==ItemStyle.Normal){
					this.optFormatStandard.Checked = true;
					this.optFormatOuter.Checked = true;
				}
				else if(value==ItemStyle.ExtendedInner){
					this.optFormatExtended.Checked = true;
					this.optFormatInner.Checked = true;
				}
				else if(value==ItemStyle.ExtendedOuter){
					this.optFormatExtended.Checked = true;
					this.optFormatOuter.Checked = true;
				}
			}
		...
		private void DrawPropertyImage()
		{
			...
			TimerBegin.RepertoryImage(g,this.TimerPosition, this.TimerStyle, this.DiagramStyle);
			g.Dispose();
		...
		void OptPropertyCheckedChanged(object sender, System.EventArgs e)
		{
			if (this.optFormatStandard.Checked == true){
				this.optFormatOuter.Checked = true;
				this.optFormatInner.Enabled = false;
			}
			else if (this.optFormatExtended.Checked == true){
				this.optFormatInner.Enabled = true;
			}
			DrawPropertyImage();
		}
