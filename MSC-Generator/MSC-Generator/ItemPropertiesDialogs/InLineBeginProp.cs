...
namespace MscItemProp
{
	...
	public class InLineBeginProp : Property
	{
				
		public InLineBeginProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgFragementBegin");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InLineBeginProp));
			this.tabItemProperty = new System.Windows.Forms.TabPage();
			this.label71 = new System.Windows.Forms.Label();
			this.txtPropInline = new System.Windows.Forms.TextBox();
			...
			this.tabItemProperty.Controls.Add(this.txtPropInline);
			...
			// txtPropInline
			// 
			this.txtPropInline.AccessibleDescription = null;
			this.txtPropInline.AccessibleName = null;
			this.txtPropInline.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropInline.Anchor")));
			this.txtPropInline.BackgroundImage = null;
			this.txtPropInline.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropInline.BackgroundImageLayout")));
			this.txtPropInline.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropInline.Dock")));
			this.txtPropInline.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropInline, resources.GetString("txtPropInline.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.txtPropInline, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropInline.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropInline, null);
			this.txtPropInline.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropInline.ImeMode")));
			this.txtPropInline.Location = ((System.Drawing.Point)(resources.GetObject("txtPropInline.Location")));
			this.txtPropInline.MaxLength = ((int)(resources.GetObject("txtPropInline.MaxLength")));
			this.txtPropInline.Multiline = ((bool)(resources.GetObject("txtPropInline.Multiline")));
			this.txtPropInline.Name = "txtPropInline";
			this.txtPropInline.PasswordChar = ((char)(resources.GetObject("txtPropInline.PasswordChar")));
			this.txtPropInline.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropInline.RightToLeft")));
			this.txtPropInline.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropInline.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropInline, ((bool)(resources.GetObject("txtPropInline.ShowHelp"))));
			this.txtPropInline.Size = ((System.Drawing.Size)(resources.GetObject("txtPropInline.Size")));
			this.txtPropInline.TabIndex = ((int)(resources.GetObject("txtPropInline.TabIndex")));
			this.txtPropInline.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropInline.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropInline, resources.GetString("txtPropInline.ToolTip"));
			this.txtPropInline.WordWrap = ((bool)(resources.GetObject("txtPropInline.WordWrap")));
			// 
			// InLineBeginProp
			// 
		...
		private System.Windows.Forms.TextBox txtPropInline;
		private System.Windows.Forms.Label label71;
		#endregion
	
		public string InlineText{
			get{
				return DeformatText(this.txtPropInline.Text);
			}
			set{
				this.txtPropInline.Text = EnformatText(value);
			}
		}
		public override string PropText{
			get{
				int pos = mEditorText.IndexOf(',')+1; // Inline iD
				pos = mEditorText.IndexOf(',', pos)+1; // first Instance
				pos = mEditorText.IndexOf(',', pos)+1; // last Instance
				string command = mEditorText.Substring(0,pos);
				command += " \"" + this.InlineText;
