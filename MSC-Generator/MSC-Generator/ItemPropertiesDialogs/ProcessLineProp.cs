...
namespace MscItemProp
{
	...
	public class ProcessLineProp : Property
	{				
		public ProcessLineProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgInstance");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProcessLineProp));
			this.tabItemProperty = new System.Windows.Forms.TabPage();
			this.groupBox31 = new System.Windows.Forms.GroupBox();
			this.label10 = new System.Windows.Forms.Label();
			this.txtPropRight = new System.Windows.Forms.TextBox();
			this.label71 = new System.Windows.Forms.Label();
			this.txtPropLeft = new System.Windows.Forms.TextBox();
			...
			this.txtPropDescription = new System.Windows.Forms.TextBox();
			this.label9 = new System.Windows.Forms.Label();
			this.txtPropProcess = new System.Windows.Forms.TextBox();
			...
			this.tabItemProperty.Controls.Add(this.groupBox31);
			this.tabItemProperty.Controls.Add(this.groupBox21);
			this.tabItemProperty.Controls.Add(this.txtPropDescription);
			this.tabItemProperty.Controls.Add(this.label9);
			this.tabItemProperty.Controls.Add(this.txtPropProcess);
			this.tabItemProperty.Controls.Add(this.label8);
			...
			this.groupBox31.Controls.Add(this.txtPropRight);
			this.groupBox31.Controls.Add(this.label71);
			this.groupBox31.Controls.Add(this.txtPropLeft);
			...
			this.hlpProvider.SetHelpKeyword(this.label10, null);
			this.hlpProvider.SetHelpNavigator(this.label10, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("label10.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.label10, null);
			...
			this.hlpProvider.SetShowHelp(this.label10, ((bool)(resources.GetObject("label10.ShowHelp"))));
			...
			this.propToolTip.SetToolTip(this.label10, resources.GetString("label10.ToolTip"));
			// 
			// txtPropRight
			// 
			this.txtPropRight.AccessibleDescription = null;
			this.txtPropRight.AccessibleName = null;
			this.txtPropRight.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropRight.Anchor")));
			this.txtPropRight.BackgroundImage = null;
			this.txtPropRight.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropRight.BackgroundImageLayout")));
			this.txtPropRight.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropRight.Dock")));
			this.txtPropRight.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropRight, resources.GetString("txtPropRight.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.txtPropRight, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropRight.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropRight, null);
			this.txtPropRight.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropRight.ImeMode")));
			this.txtPropRight.Location = ((System.Drawing.Point)(resources.GetObject("txtPropRight.Location")));
			this.txtPropRight.MaxLength = ((int)(resources.GetObject("txtPropRight.MaxLength")));
			this.txtPropRight.Multiline = ((bool)(resources.GetObject("txtPropRight.Multiline")));
			this.txtPropRight.Name = "txtPropRight";
			this.txtPropRight.PasswordChar = ((char)(resources.GetObject("txtPropRight.PasswordChar")));
			this.txtPropRight.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropRight.RightToLeft")));
			this.txtPropRight.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropRight.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropRight, ((bool)(resources.GetObject("txtPropRight.ShowHelp"))));
			this.txtPropRight.Size = ((System.Drawing.Size)(resources.GetObject("txtPropRight.Size")));
			this.txtPropRight.TabIndex = ((int)(resources.GetObject("txtPropRight.TabIndex")));
			this.txtPropRight.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropRight.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropRight, resources.GetString("txtPropRight.ToolTip"));
			this.txtPropRight.WordWrap = ((bool)(resources.GetObject("txtPropRight.WordWrap")));
			this.txtPropRight.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Internal_KeyPress);
			// 
			// label71
			// 
			...
			// txtPropLeft
			// 
			this.txtPropLeft.AccessibleDescription = null;
			this.txtPropLeft.AccessibleName = null;
			this.txtPropLeft.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropLeft.Anchor")));
			this.txtPropLeft.BackgroundImage = null;
			this.txtPropLeft.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropLeft.BackgroundImageLayout")));
			this.txtPropLeft.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropLeft.Dock")));
			this.txtPropLeft.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropLeft, resources.GetString("txtPropLeft.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.txtPropLeft, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropLeft.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropLeft, null);
			this.txtPropLeft.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropLeft.ImeMode")));
			this.txtPropLeft.Location = ((System.Drawing.Point)(resources.GetObject("txtPropLeft.Location")));
			this.txtPropLeft.MaxLength = ((int)(resources.GetObject("txtPropLeft.MaxLength")));
			this.txtPropLeft.Multiline = ((bool)(resources.GetObject("txtPropLeft.Multiline")));
			this.txtPropLeft.Name = "txtPropLeft";
			this.txtPropLeft.PasswordChar = ((char)(resources.GetObject("txtPropLeft.PasswordChar")));
			this.txtPropLeft.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropLeft.RightToLeft")));
			this.txtPropLeft.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropLeft.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropLeft, ((bool)(resources.GetObject("txtPropLeft.ShowHelp"))));
			this.txtPropLeft.Size = ((System.Drawing.Size)(resources.GetObject("txtPropLeft.Size")));
			this.txtPropLeft.TabIndex = ((int)(resources.GetObject("txtPropLeft.TabIndex")));
			this.txtPropLeft.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropLeft.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropLeft, resources.GetString("txtPropLeft.ToolTip"));
			this.txtPropLeft.WordWrap = ((bool)(resources.GetObject("txtPropLeft.WordWrap")));
			this.txtPropLeft.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Internal_KeyPress);
			// 
			// groupBox21
			// 
			...
			this.optType3.CheckedChanged += new System.EventHandler(this.OptTypeCheckedChanged);
			// 
			// optType2
			// 
			...
			this.optType2.CheckedChanged += new System.EventHandler(this.OptTypeCheckedChanged);
			// 
			// optType1
			// 
			...
			this.optType1.CheckedChanged += new System.EventHandler(this.OptTypeCheckedChanged);
			// 
			// picPreview
			// 
			...
			// txtPropDescription
			// 
			this.txtPropDescription.AccessibleDescription = null;
			this.txtPropDescription.AccessibleName = null;
			this.txtPropDescription.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropDescription.Anchor")));
			this.txtPropDescription.BackgroundImage = null;
			this.txtPropDescription.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropDescription.BackgroundImageLayout")));
			this.txtPropDescription.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropDescription.Dock")));
			this.txtPropDescription.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropDescription, resources.GetString("txtPropDescription.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.txtPropDescription, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropDescription.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropDescription, null);
			this.txtPropDescription.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropDescription.ImeMode")));
			this.txtPropDescription.Location = ((System.Drawing.Point)(resources.GetObject("txtPropDescription.Location")));
			this.txtPropDescription.MaxLength = ((int)(resources.GetObject("txtPropDescription.MaxLength")));
			this.txtPropDescription.Multiline = ((bool)(resources.GetObject("txtPropDescription.Multiline")));
			this.txtPropDescription.Name = "txtPropDescription";
			this.txtPropDescription.PasswordChar = ((char)(resources.GetObject("txtPropDescription.PasswordChar")));
			this.txtPropDescription.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropDescription.RightToLeft")));
			this.txtPropDescription.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropDescription.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropDescription, ((bool)(resources.GetObject("txtPropDescription.ShowHelp"))));
			this.txtPropDescription.Size = ((System.Drawing.Size)(resources.GetObject("txtPropDescription.Size")));
			this.txtPropDescription.TabIndex = ((int)(resources.GetObject("txtPropDescription.TabIndex")));
			this.txtPropDescription.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropDescription.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropDescription, resources.GetString("txtPropDescription.ToolTip"));
			this.txtPropDescription.WordWrap = ((bool)(resources.GetObject("txtPropDescription.WordWrap")));
			// 
			// label9
			// 
			...
			this.hlpProvider.SetHelpKeyword(this.label9, null);
			this.hlpProvider.SetHelpNavigator(this.label9, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("label9.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.label9, null);
			...
			this.hlpProvider.SetShowHelp(this.label9, ((bool)(resources.GetObject("label9.ShowHelp"))));
			...
			this.propToolTip.SetToolTip(this.label9, resources.GetString("label9.ToolTip"));
			// 
			// txtPropProcess
			// 
			this.txtPropProcess.AccessibleDescription = null;
			this.txtPropProcess.AccessibleName = null;
			this.txtPropProcess.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropProcess.Anchor")));
			this.txtPropProcess.BackgroundImage = null;
			this.txtPropProcess.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropProcess.BackgroundImageLayout")));
			this.txtPropProcess.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropProcess.Dock")));
			this.txtPropProcess.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropProcess, resources.GetString("txtPropProcess.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.txtPropProcess, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropProcess.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropProcess, null);
			this.txtPropProcess.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropProcess.ImeMode")));
			this.txtPropProcess.Location = ((System.Drawing.Point)(resources.GetObject("txtPropProcess.Location")));
			this.txtPropProcess.MaxLength = ((int)(resources.GetObject("txtPropProcess.MaxLength")));
			this.txtPropProcess.Multiline = ((bool)(resources.GetObject("txtPropProcess.Multiline")));
			this.txtPropProcess.Name = "txtPropProcess";
			this.txtPropProcess.PasswordChar = ((char)(resources.GetObject("txtPropProcess.PasswordChar")));
			this.txtPropProcess.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropProcess.RightToLeft")));
			this.txtPropProcess.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropProcess.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropProcess, ((bool)(resources.GetObject("txtPropProcess.ShowHelp"))));
			this.txtPropProcess.Size = ((System.Drawing.Size)(resources.GetObject("txtPropProcess.Size")));
			this.txtPropProcess.TabIndex = ((int)(resources.GetObject("txtPropProcess.TabIndex")));
			this.txtPropProcess.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropProcess.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropProcess, resources.GetString("txtPropProcess.ToolTip"));
			this.txtPropProcess.WordWrap = ((bool)(resources.GetObject("txtPropProcess.WordWrap")));
			// 
			// label8
			// 
		...
		private System.Windows.Forms.TextBox txtPropRight;
		private System.Windows.Forms.TextBox txtPropLeft;
		...
		private System.Windows.Forms.TextBox txtPropProcess;
		private System.Windows.Forms.Label label9;
		private System.Windows.Forms.TextBox txtPropDescription;
		...
		public override string PropText{
			get{
				...
				int pos = mEditorText.IndexOf(':')+1;
				int pos2 = mEditorText.IndexOf(',')+1;
				string id = string.Empty;
				if (pos2>0){
					id = mEditorText.Substring(pos,((mEditorText.IndexOf(',')+1)-pos));
				}
				else{
					int i = pos;
					if (mEditorText.EndsWith(";")) i++;
					if (mEditorText.EndsWith(";;")) i++;
					id = mEditorText.Substring(pos,((mEditorText.Length)-i)) + ",";
				}
				pos = mEditorText.ToLower().IndexOf("actor:"); // source Instance
				if (pos==-1) 
					pos = mEditorText.ToLower().IndexOf("dummyprocess:");
				if (pos==-1)
					pos = mEditorText.ToLower().IndexOf("process:");
				if (pos==-1)
					return "";
				string command = mEditorText.Substring(0,pos);
				if (this.optType1.Checked == true){
					command += "process:" + id;
					command += "\"" + this.ProcessText + "\"," + "\"" + this.DescriptionText + "\", ";
				}
					...
					command += "dummyprocess:" + id;
				}
				command += this.LeftText + ", " + this.RightText;
		...
		public string ProcessText{
			get{
				return DeformatText(this.txtPropProcess.Text);
			}
			set{
				this.txtPropProcess.Text = EnformatText(value);
			}
		}	
		public string DescriptionText{
			get{
				return DeformatText(this.txtPropDescription.Text);
			}
			set{
				this.txtPropDescription.Text = EnformatText(value);
			}
		}	
		public uint LeftText{
			get{
				if (this.txtPropLeft.Text.Trim().Length == 0)
					this.txtPropLeft.Text = "0";
				return uint.Parse( this.txtPropLeft.Text);
			}
			set{
				this.txtPropLeft.Text = value.ToString();
			}
		}	
		public uint RightText{
			get{
				if (this.txtPropRight.Text.Trim().Length == 0)
					this.txtPropRight.Text = "0";
				return uint.Parse( this.txtPropRight.Text);
			}
			set{
				this.txtPropRight.Text = value.ToString();
			}
		}	
		public ProcessType Type{
			get{
				if(this.optType1.Checked == true)
					...
					return ProcessType.Actor;
				else if(this.optType3.Checked == true)
					return ProcessType.Dummy;
				return ProcessType.Normal;				
			}
			set{
				if(value==ProcessType.Normal)
					this.optType1.Checked = true;
				else if(value==ProcessType.Actor)
					this.optType2.Checked = true;
				else if(value==ProcessType.Dummy)
		...
		protected override void CmdAcceptClick(object sender, System.EventArgs e)
		{
			...
			try{
				int v = Int32.Parse(this.txtPropRight.Text);
				if (v>200) this.txtPropRight.Text = "200";
			}
			catch{
				this.txtPropRight.Text = "200";
			}
			try{
				int v = Int32.Parse(this.txtPropLeft.Text);
				if (v>200) this.txtPropLeft.Text = "200";
			}
			catch{
				this.txtPropLeft.Text = "200";
			}
			base.CmdAcceptClick(sender, e);
		}
		protected void Internal_KeyPress (object sender, KeyPressEventArgs e)
		{
			if((!char.IsDigit(e.KeyChar)) && 
			        (!e.KeyChar.Equals((char)((int)Keys.Back))) && 
			        (!e.KeyChar.Equals((char)((int)Keys.Delete))) &&
			        (!e.KeyChar.Equals((char)((int)Keys.Left))) &&
			        (!e.KeyChar.Equals((char)((int)Keys.Right)))){
			        	e.Handled = true;
			}
		...
		private void DrawPropertyImage()
		{
			...
			ProcessLine.RepertoryImage(g,this.Type);
			g.Dispose();
			this.picPreview.Invalidate();		
		}
		
		void OptTypeCheckedChanged(object sender, System.EventArgs e)
		{	
			if(this.optType3.Checked == true){
				this.txtPropProcess.Enabled = false;
				this.txtPropDescription.Enabled = false;
			}
			else{
				this.txtPropProcess.Enabled = true;
				this.txtPropDescription.Enabled = true;
			}
			DrawPropertyImage();
		}
