...
namespace MscItemProp
{
	...
	public class InLineTextProp : Property
	{
				
		public InLineTextProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgFragmentText");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InLineTextProp));
		...
		public string InlineText{
			get{
				string text = this.txtPropInline.Text;
				text = text.Replace("\r\n","\\n");
				return text;
			}
			set{
		...
		public override string PropText{
			get{
				...
				command += " \"" + this.txtPropInline.Text + "\"";
