...
namespace MscItemProp
{
	...
	public class SetTimerProp : Property
	{
		public SetTimerProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgSetTimer");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SetTimerProp));
		...
		private void DrawPropertyImage()
		{
			...
			SetTimer.RepertoryImage(g,this.TimerPosition);
			g.Dispose();
