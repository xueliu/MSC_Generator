...
namespace MscItemProp
{
	...
	public class MessageBeginProp : Property
	{
		public MessageBeginProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgMessageBegin");
		...
		private void DrawPropertyImage()
		{
			...
			MessageBegin.RepertoryImage(g,this.Style, this.DiagramStyle);
			g.Dispose();
