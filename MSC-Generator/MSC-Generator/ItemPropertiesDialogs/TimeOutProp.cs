...
namespace MscItemProp
{
	...
	public class TimeOutProp : Property
	{				
		public TimeOutProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgTimeOut");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TimeOutProp));
		...
		private void DrawPropertyImage()
		{
			...
			TimeOut.RepertoryImage(g,this.TimerPosition);
			g.Dispose();
