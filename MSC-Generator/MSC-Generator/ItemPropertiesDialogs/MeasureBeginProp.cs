...
namespace MscItemProp
{
	...
	public class MeasureBeginProp : Property
	{
		public MeasureBeginProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgMeasureBegin");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MeasureBeginProp));
			...
			this.tabItemProperty.Controls.Add(this.txtPropMeasure);
		...
		private void DrawPropertyImage()
		{
			...
			MeasureBeginn.RepertoryImage(g,this.MeasurePosition, this.MeasureStyle);
			g.Dispose();
