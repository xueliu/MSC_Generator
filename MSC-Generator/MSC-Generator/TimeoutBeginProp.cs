...
namespace MscItemProp
{
	...
	public class TimeoutBeginProp : Property
	{
		public TimeoutBeginProp()
		{
			//
...
//			this.UseStyle(this.DiagramStyle);
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TimeoutBeginProp));
			...
			this.hlpProvider.SetHelpKeyword(this.optFormatExtended, resources.GetString("optFormatExtended.HelpKeyword"));
			...
			this.hlpProvider.SetHelpKeyword(this.optFormatStandard, resources.GetString("optFormatStandard.HelpKeyword"));
			...
			this.hlpProvider.SetHelpKeyword(this.txtPropTimeout, resources.GetString("txtPropTimeout.HelpKeyword"));
		...
		public override string PropText{
			get{
				string command = mEditorText.Substring(0,mEditorText.IndexOf(',')+1);
				command += "\"" + this.TimeoutText + "\",";
		...
		public ItemPos TimeoutPosition{
			get{
				if(this.optDirectionL.Checked == true)
					return ItemPos.Left;
				else if(this.optDirectionR.Checked == true)
		...
		private void DrawPropertyImage()
		{
			...
			TimeoutBegin.RepertoryImage(g,this.TimeoutPosition, this.TimeoutStyle, this.DiagramStyle);
			g.Dispose();
