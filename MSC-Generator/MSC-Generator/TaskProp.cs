...
namespace MscItemProp
{
	...
	public class TaskProp : Property
	{				
		public TaskProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgTask");
		...
		private void InitializeComponent() {
			...
			this.txtPropTask = new System.Windows.Forms.TextBox();
			...
			this.tabItemProperty.Controls.Add(this.txtPropTask);
			...
			// txtPropTask
			// 
			this.txtPropTask.AccessibleDescription = null;
			this.txtPropTask.AccessibleName = null;
			this.txtPropTask.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropTask.Anchor")));
			this.txtPropTask.BackgroundImage = null;
			this.txtPropTask.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropTask.BackgroundImageLayout")));
			this.txtPropTask.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropTask.Dock")));
			this.txtPropTask.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropTask, resources.GetString("txtPropTask.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.txtPropTask, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropTask.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropTask, null);
			this.txtPropTask.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropTask.ImeMode")));
			this.txtPropTask.Location = ((System.Drawing.Point)(resources.GetObject("txtPropTask.Location")));
			this.txtPropTask.MaxLength = ((int)(resources.GetObject("txtPropTask.MaxLength")));
			this.txtPropTask.Multiline = ((bool)(resources.GetObject("txtPropTask.Multiline")));
			this.txtPropTask.Name = "txtPropTask";
			this.txtPropTask.PasswordChar = ((char)(resources.GetObject("txtPropTask.PasswordChar")));
			this.txtPropTask.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropTask.RightToLeft")));
			this.txtPropTask.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropTask.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropTask, ((bool)(resources.GetObject("txtPropTask.ShowHelp"))));
			this.txtPropTask.Size = ((System.Drawing.Size)(resources.GetObject("txtPropTask.Size")));
			this.txtPropTask.TabIndex = ((int)(resources.GetObject("txtPropTask.TabIndex")));
			this.txtPropTask.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropTask.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropTask, resources.GetString("txtPropTask.ToolTip"));
			this.txtPropTask.WordWrap = ((bool)(resources.GetObject("txtPropTask.WordWrap")));
			// 
			// TaskProp
			// 
		...
		private System.Windows.Forms.TextBox txtPropTask;
		#endregion
		private System.Windows.Forms.Label label71;
		
		public string TaskText{
			get{
				return DeformatText(this.txtPropTask.Text);
			}
			set{
				this.txtPropTask.Text = EnformatText(value);
			}
		}	
		public ItemPos TaskPosition{
			get{
		...
		private void DrawPropertyImage()
		{
			...
			Task.RepertoryImage(g, ItemPos.Top);
			g.Dispose();
