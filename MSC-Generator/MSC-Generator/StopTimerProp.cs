...
namespace MscItemProp
{
	...
	public class StopTimerProp : Property
	{
		public StopTimerProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgStopTimer");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(StopTimerProp));
			...
			this.txtPropTimer = new System.Windows.Forms.TextBox();
			...
			this.tabItemProperty.Controls.Add(this.txtPropTimer);
			...
			// txtPropTimer
			// 
			this.txtPropTimer.AccessibleDescription = null;
			this.txtPropTimer.AccessibleName = null;
			this.txtPropTimer.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("txtPropTimer.Anchor")));
			this.txtPropTimer.BackgroundImage = null;
			this.txtPropTimer.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("txtPropTimer.BackgroundImageLayout")));
			this.txtPropTimer.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("txtPropTimer.Dock")));
			this.txtPropTimer.Font = null;
			this.hlpProvider.SetHelpKeyword(this.txtPropTimer, resources.GetString("txtPropTimer.HelpKeyword"));
			this.hlpProvider.SetHelpNavigator(this.txtPropTimer, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("txtPropTimer.HelpNavigator"))));
			this.hlpProvider.SetHelpString(this.txtPropTimer, null);
			this.txtPropTimer.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("txtPropTimer.ImeMode")));
			this.txtPropTimer.Location = ((System.Drawing.Point)(resources.GetObject("txtPropTimer.Location")));
			this.txtPropTimer.MaxLength = ((int)(resources.GetObject("txtPropTimer.MaxLength")));
			this.txtPropTimer.Multiline = ((bool)(resources.GetObject("txtPropTimer.Multiline")));
			this.txtPropTimer.Name = "txtPropTimer";
			this.txtPropTimer.PasswordChar = ((char)(resources.GetObject("txtPropTimer.PasswordChar")));
			this.txtPropTimer.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("txtPropTimer.RightToLeft")));
			this.txtPropTimer.ScrollBars = ((System.Windows.Forms.ScrollBars)(resources.GetObject("txtPropTimer.ScrollBars")));
			this.hlpProvider.SetShowHelp(this.txtPropTimer, ((bool)(resources.GetObject("txtPropTimer.ShowHelp"))));
			this.txtPropTimer.Size = ((System.Drawing.Size)(resources.GetObject("txtPropTimer.Size")));
			this.txtPropTimer.TabIndex = ((int)(resources.GetObject("txtPropTimer.TabIndex")));
			this.txtPropTimer.TextAlign = ((System.Windows.Forms.HorizontalAlignment)(resources.GetObject("txtPropTimer.TextAlign")));
			this.propToolTip.SetToolTip(this.txtPropTimer, resources.GetString("txtPropTimer.ToolTip"));
			this.txtPropTimer.WordWrap = ((bool)(resources.GetObject("txtPropTimer.WordWrap")));
			// 
			// StopTimerProp
			// 
		...
		private System.Windows.Forms.TextBox txtPropTimer;
		...
		public string TimerText{
			get{
				return DeformatText(this.txtPropTimer.Text);
			}
			set{
				this.txtPropTimer.Text = EnformatText(value);
			}
		}
		...
		private void DrawPropertyImage()
		{
			...
			StopTimer.RepertoryImage(g,this.TimerPosition);
			g.Dispose();
