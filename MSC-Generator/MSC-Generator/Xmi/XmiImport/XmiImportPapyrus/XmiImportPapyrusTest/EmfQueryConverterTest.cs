...
namespace xmiImportPapyrus
{
	...
	{
		private const string ONE_EMF_QUERY="/1/@contained.0/@contained.0";
		private const string FIRST_EXPECTED_XPATH_QUERY="contained[1]/contained[1]";
		private const string TWO_EMF_QUERY="/1/@contained.0/@contained.1 /1/@contained.0/@contained.2";
		private const string FIRST_OF_TWO_EXPECTED_XPATH_QUERY="contained[1]/contained[2]";
		private const string SECOND_OF_TWO_EXPECTED_XPATH_QUERY="contained[1]/contained[3]";
		private const string ONE_EMF_QUERY_DEPTH_TWO_ELEMENTS="/1/@contained.0/@contained.1/@anchorage.0";
		private const string ONE_EXPECTED_QUERY_DEPTH_TWO_ELEMENTS="contained[1]/contained[2]/anchorage[1]";
		...
		private const string FIRST_OF_TWO_EXPECTED_QUERY_DEPTH_TWO_ELEMENTS="contained[1]/contained[2]/anchorage[1]";
		private const string SECOND_OF_TWO_EXPECTED_QUERY_DEPTH_TWO_ELEMENTS="contained[1]/contained[3]/anchorage[2]";
		...
		private const string FIRST_OF_THREE_EXPECTED_QUERY_DEPTH_THREE_ELEMENTS="contained[1]/contained[2]/contained[3]/anchorage[4]";
		private const string SECOND_OF_THREE_EXPECTED_QUERY_DEPTH_THREE_ELEMENTS="contained[1]/contained[5]/contained[6]/anchorage[7]";
		private const string THIRD_OF_THREE_EXPECTED_QUERY_DEPTH_THREE_ELEMENTS="contained[1]/contained[8]/contained[9]/anchorage[10]";
