...
namespace xmi
{
	...
	public class UmlModelElements
	{
		...
		public const string LIFELINE_TYPE_ATTR_VALUE="uml:Lifeline";
		public const string MESSAGE_TYPE_ATTR_VALUE="uml:Message";
		public const string BEHAVIOR_EXECUTION_SPEC_TYPE_ATTR_VALUE="uml:BehaviorExecutionSpecification";
		public const string EXECUTION_OCCURRENCE_SPEC_TYPE_ATTR_VALUE="uml:ExecutionOccurrenceSpecification";
		public const string MESSAGE_OCCURRENCE_SPEC_TYPE_ATTR_VALUE="uml:MessageOccurrenceSpecification";
	}
}
