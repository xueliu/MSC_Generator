...
namespace mscElements
{
	...
	/// </summary>
	public partial class TimeoutBegin : MSCItem
	{
		...
		public TimeoutBegin(uint fileLine, string name, uint line, int process)
		{
			this.mName 				= name;
			this.mLine 				= line;
		...
		public TimeoutBegin(uint fileLine, uint line, int process)
		{
			this.mName 				= "";
			this.mLine 				= line;
			this.mProcess 			= process;
		...
		public TimeoutBegin(uint fileLine, string name, uint line, int process, ItemPos placement)
		{
			this.mName 				= name;
			this.mLine 				= line;
			this.mProcess 			= process;
		...
		public TimeoutBegin(uint fileLine, uint line, int process, ItemPos placement)
		{
			this.mName 				= "";
			this.mLine 				= line;
			this.mProcess 			= process;
		...
		public TimeoutBegin(uint fileLine, string name, uint line, int process, ItemPos placement, ItemStyle itemstyle)
		{
			this.mName 				= name;
			this.mLine 				= line;
			this.mProcess 			= process;
		...
		public TimeoutBegin(uint fileLine, uint line, int process, ItemPos placement, ItemStyle itemstyle)
		{
			this.mName 				= "";
			this.mLine 				= line;
			this.mProcess 			= process;
