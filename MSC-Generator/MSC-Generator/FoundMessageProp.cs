...
namespace MscItemProp
{
	...
	public class FoundMessageProp : Property
	{
				
		public FoundMessageProp()
		{
			//
			...
			this.hlpProvider.SetHelpKeyword(this.tabOptions, "dlgFoundMessage");
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FoundMessageProp));
			...
			this.tabItemProperty.Controls.Add(this.txtPropGate);
		...
		public override string PropText{
			get{
				...
				command += " \"" + this.MessageText + "\",\"" + this.GateText + "\",";
		...
		public MessagePos MessagePosition{
			get{
				if(this.optDirectionL.Checked == true)
					return MessagePos.Left;
				else if(this.optDirectionR.Checked == true)
					return MessagePos.Right;
				return MessagePos.Left;				
			}
			set{
				if(value==MessagePos.Left)
					this.optDirectionL.Checked = true;
				else if(value==MessagePos.Right)
		...
		private void DrawPropertyImage()
		{
			...
			if (this.optDirectionL.Checked == true){
				FoundMessage.RepertoryImage(g,MessagePos.Left, this.DiagramStyle);
			}
			else{
				FoundMessage.RepertoryImage(g,MessagePos.Right, this.DiagramStyle);
			}
			g.Dispose();
